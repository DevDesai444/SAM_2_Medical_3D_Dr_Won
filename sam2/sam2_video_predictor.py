...
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_state(
        ...
        # Use the device from the model (supports both CPU and CUDA)
    ...
    def add_new_points(
        ...
        if prev_out is not None and prev_out["pred_masks"] is not None:
            ...
            prev_sam_mask_logits = prev_out["pred_masks"].to('cpu')
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        if backbone_out is None:
            ...
            image = inference_state["images"][frame_idx].to('cpu').float().unsqueeze(0)
